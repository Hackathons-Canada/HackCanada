...
const createIconComponent =
  ...
  ({
    ...
    `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="${className}" viewBox="${iconPaths[name].viewBox}"><path d="${iconPaths[name].path}"/></svg>`;
